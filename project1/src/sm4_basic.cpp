...
__m128i SM4_round(__m128i x0,__m128i x1, __m128i x2, __m128i x3, uint32_t rk) {
    ...
    __m128i res = _mm_load_si128((__m128i*)arr);
    return(_mm_xor_si128(x0, res));
}


void SM4_ENC_SIMD_4(const uint32_t IN[4][4],uint32_t OUT[4][4], const uint32_t rk[32]) {
    ...
    for (int round = 0; round < 32; round++) {
        __m128i tmp = SM4_round(x0, x1, x2, x3, rk[round]);
